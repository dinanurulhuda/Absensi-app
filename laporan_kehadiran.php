...
<div class="col" role="main">
    <div class="col-md-12 col-sm-12  ">
        ...
        <center><h2>LAPORAN JADWAL KEHADIRAN PERKELAS</h2></center>
                    ...
                    <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                            ...
                            <td><center><?php echo $no;?></center></td>
                                ...
                                <td><center>
                                    <a href="index2.php?p=laporan_hadir_perkelas&id_kelas=<?php echo $data["id_kelas"]; ?>" class="btn btn-sm btn-success">Pilih Kelas</a>
                                </center></td>
                            </tr>
                        </tbody>
                        <?php
