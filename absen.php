                    ...
                    <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                            ...
                            <td><center><?php echo $no;?></center></td>
                                ...
                                <td><center>MI <?php echo $data["nama_kelas"]; ?></center></td>
                                <td><center>
                                    <a href="index2.php?p=absen_masuk&&nim=<?php echo $data["nim"]; ?>" class="btn btn-sm btn-success">Absen Masuk</a>
                                    <a href="index2.php?p=absen_keluar&&nim=<?php echo $data["nim"]; ?>" class="btn btn-sm btn-danger">Absen Keluar</a>
                                    </center></td>
                            </tr>
                        </tbody>
                        <?php
